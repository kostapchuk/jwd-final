    ...
    <div class="offset-md-2 col-md-8">
        ...
        <form action="${pageContext.request.contextPath}/controller?command=create_event" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="firstTeamCoefficientId"
                       name="firstTeamCoefficient" required>
            </div>
            <div class="form-group">
                <label for="secondTeamCoefficientId"><ut:locale_tag key="bookmaker.second-team-coefficient"/></label>
                <input type="number" step="0.01" class="form-control" id="secondTeamCoefficientId"
                       name="secondTeamCoefficient" required>
            </div>
            <div class="form-group">
                <label for="drawCoefficientId"><ut:locale_tag key="bookmaker.draw-coefficient"/></label>
                <input type="number" step="0.01" class="form-control" id="drawCoefficientId" name="drawCoefficient"
                       required>
            </div>
            ...
            <table class="table">
                ...
                <c:forEach var="match" items="${requestScope.matches}">
                    <tr>
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/controller?command=finish_event"
                                  method="post">
                                <div class="form-group">
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath}/controller?command=cancel_event"
                                  method="post">
                                <input type="hidden" name="matchId" value="${match.id}"/>
