                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <c:if test="${not empty sessionScope.userName}">
                                            <button class="btn btn-primary btn-block" data-toggle="modal"
                                                    data-target="#makeBet" data-whatever-result="FIRST_TEAM"
                                                    data-whatever-id="${event.matchDto.id}"
                                                    data-whatever-coef="${event.firstTeamCoefficient}">
                                    ...
                                    <td>
                                        <c:if test="${not empty sessionScope.userName}">
                                            <button class="btn btn-primary btn-block" data-toggle="modal"
                                                    data-target="#makeBet" data-whatever-result="DRAW"
                                                    data-whatever-id="${event.matchDto.id}"
                                                    data-whatever-coef="${event.drawCoefficient}">
                                    ...
                                    <td>
                                        <c:if test="${not empty sessionScope.userName}">
                                            <button class="btn btn-primary btn-block" data-toggle="modal"
                                                    data-target="#makeBet" data-whatever-result="SECOND_TEAM"
                                                    data-whatever-id="${event.matchDto.id}"
                                                    data-whatever-coef="${event.secondTeamCoefficient}">
